...
var _default = (0, _curry.default)( /*#__PURE__*/_regenerator.default.mark(function takeL(l, iter) {
  var prev, _iterator, _step, _loop, _ret;

  return _regenerator.default.wrap(function takeL$(_context2) {
    while (1) {
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return prev = (prev || _promise.default.resolve()).then(function (_) {
                      ...
                      return --l > -1 ? a : _promise.default.reject(_nop.default);
                    });
