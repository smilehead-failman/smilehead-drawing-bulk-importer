...
var _marked = /*#__PURE__*/_regeneratorRuntime2.mark(zipWithIndexL);
...
function zipWithIndexL(iter) {
  ...
  return _regenerator.default.wrap(function zipWithIndexL$(_context2) {
    while (1) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _i = ++i;
                    _context.next = 4;
                    return (0, _go.default)(a, function (a) {
                      return [_i, a];
                    });
