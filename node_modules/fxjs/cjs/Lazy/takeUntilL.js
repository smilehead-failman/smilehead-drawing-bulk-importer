...
var _default = (0, _curry.default)( /*#__PURE__*/_regenerator.default.mark(function takeUntilL(f, iter) {
  var prev, ok, _iterator, _step, _loop, _ret;

  return _regenerator.default.wrap(function takeUntilL$(_context2) {
    while (1) {
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return prev = (prev || _promise.default.resolve()).then(function (_) {
                      ...
                      return ok ? _promise.default.reject(_nop.default) : (ok = _ok, a);
                    });
