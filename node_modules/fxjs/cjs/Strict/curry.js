...
function curry(f) {
  return function (a) {
    ...
    return _.length ? f.apply(void 0, (0, _concat.default)(_context = [a]).call(_context, _)) : function () {
      var _context2;
      ...
      return f.apply(void 0, (0, _concat.default)(_context2 = [a]).call(_context2, _));
    };
  };
}