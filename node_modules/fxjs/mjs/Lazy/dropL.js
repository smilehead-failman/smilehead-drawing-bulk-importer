...
export default curry( /*#__PURE__*/_regeneratorRuntime.mark(function dropL(l, iter) {
  var prev, i, _iterator, _step, _loop, _ret;

  return _regeneratorRuntime.wrap(function dropL$(_context2) {
    while (1) {
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return prev = (prev || _Promise.resolve()).then(function (_) {
                      ...
                      return ++i > l ? b : _Promise.reject(nop);
                    });
