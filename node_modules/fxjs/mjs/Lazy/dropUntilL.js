...
export default curry( /*#__PURE__*/_regeneratorRuntime.mark(function dropUntilL(f, iter) {
  var prev, ok, _iterator, _step, _loop, _ret;

  return _regeneratorRuntime.wrap(function dropUntilL$(_context2) {
    while (1) {
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return prev = (prev || _Promise.resolve()).then(function (_) {
                      ...
                      return ok ? a : (ok = c, _Promise.reject(nop));
                    });
